...
use Core\Middleware\ThrottleRequests;
...
$app->register(Core\Providers\RouteServiceProvider::class);
$app->register(Core\Providers\FormRequestServiceProvider::class);
